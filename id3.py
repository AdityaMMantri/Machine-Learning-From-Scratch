...
class Decision_tree:
    ...
    def fit(self,X,y):
        ...
        self.root=self.decision_tree(X,y,list(range(X.shape[1])))
    ...
    def decision_tree(self,X,y,features,depth=0):
        ...
        best_feature,best_threshold,left_indices,right_indices= self.best_split(X, y)
...
dot.render("Utree_visualization_id3", format="png", cleanup=True)
